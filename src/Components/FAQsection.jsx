...
const FAQSection = () => {
  ...
  return (
    <section className="py-10 px-4 md:py-15 md:px-16 bg-[#F8F5F2]">
      
  {/* Heading */}
  <div className="text-center mb-10 md:mb-16">
    <h2 className="text-2xl md:text-4xl font-bold text-[#4B2E2B] mb-3 md:mb-4">
      Got Questions?
    </h2>
  ...
  {/* FAQ List */}
  <div className="max-w-4xl mx-auto space-y-2 md:space-y-1">
    {faqs.map((faq, index) => {
      ...
      return (
        <div
          key={index}
          className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-200 transition duration-300"
        >
          {/* Question */}
          <button
          ...
          >
            <span className="text-sm md:text-lg font-semibold text-[#4B2E2B] pr-3">
              {faq.question}
            </span>

            <div className="w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center bg-[#8B5E3C]/10">
              {isOpen ? (
  ...
  <div className="mt-8 md:mt-10 max-w-4xl mx-auto">
    <div className="bg-[#8B5E3C] rounded-2xl md:rounded-[30px] py-6 md:py-8 px-4 md:px-16 text-center text-white shadow-lg">
